...
#pragma mark YYProgressLayer

@interface YYProgressLayer : CALayer
...
+ (Class)layerClass {
    return [YYProgressLayer class];
}

- (YYProgressLayer *)progressLayer {
    return (YYProgressLayer *)self.layer;
}
