...
@implementation YYMessageTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [YYMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [YYMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [YYMessageTextView maxCharactersPerLine]) + 1;
}
